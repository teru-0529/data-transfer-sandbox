...
type OrderDetail struct { // 受注番号
	...
	// 受注数
	ReceivingQuantity null.Int `boil:"receiving_quantity" json:"receiving_quantity,omitempty" toml:"receiving_quantity" yaml:"receiving_quantity,omitempty"`
	// 出荷済フラグ
	ShippingFlag null.Bool `boil:"shipping_flag" json:"shipping_flag,omitempty" toml:"shipping_flag" yaml:"shipping_flag,omitempty"`
	// キャンセルフラグ
	CanceledFlag null.Bool `boil:"canceled_flag" json:"canceled_flag,omitempty" toml:"canceled_flag" yaml:"canceled_flag,omitempty"`
	// 販売単価
...
var OrderDetailWhere = struct {
	...
	ReceivingQuantity whereHelpernull_Int
	ShippingFlag      whereHelpernull_Bool
	CanceledFlag      whereHelpernull_Bool
	...
	OrderNo:           whereHelperint{field: "\"source\".\"order_details\".\"order_no\""},
	OrderDetailNo:     whereHelperint{field: "\"source\".\"order_details\".\"order_detail_no\""},
	ProductName:       whereHelpernull_String{field: "\"source\".\"order_details\".\"product_name\""},
	ReceivingQuantity: whereHelpernull_Int{field: "\"source\".\"order_details\".\"receiving_quantity\""},
	ShippingFlag:      whereHelpernull_Bool{field: "\"source\".\"order_details\".\"shipping_flag\""},
	CanceledFlag:      whereHelpernull_Bool{field: "\"source\".\"order_details\".\"canceled_flag\""},
	SelllingPrice:     whereHelperint{field: "\"source\".\"order_details\".\"sellling_price\""},
	CostPrice:         whereHelperint{field: "\"source\".\"order_details\".\"cost_price\""},
	CreatedAt:         whereHelpertime_Time{field: "\"source\".\"order_details\".\"created_at\""},
	UpdatedAt:         whereHelpertime_Time{field: "\"source\".\"order_details\".\"updated_at\""},
	CreatedBy:         whereHelpernull_String{field: "\"source\".\"order_details\".\"created_by\""},
	UpdatedBy:         whereHelpernull_String{field: "\"source\".\"order_details\".\"updated_by\""},
}
...
var (
	orderDetailAllColumns            = []string{"order_no", "order_detail_no", "product_name", "receiving_quantity", "shipping_flag", "canceled_flag", "sellling_price", "cost_price", "created_at", "updated_at", "created_by", "updated_by"}
	orderDetailColumnsWithoutDefault = []string{"order_no", "order_detail_no", "sellling_price", "cost_price"}
	orderDetailColumnsWithDefault    = []string{"product_name", "receiving_quantity", "shipping_flag", "canceled_flag", "created_at", "updated_at", "created_by", "updated_by"}
...
// OneG returns a single orderDetail record from the query using the global executor.
func (q orderDetailQuery) OneG(ctx context.Context) (*OrderDetail, error) {
...
func (q orderDetailQuery) One(ctx context.Context, exec boil.ContextExecutor) (*OrderDetail, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "source: failed to execute a one query for order_details")
	}
...
// AllG returns all OrderDetail records from the query using the global executor.
func (q orderDetailQuery) AllG(ctx context.Context) (OrderDetailSlice, error) {
...
func (q orderDetailQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrderDetailSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "source: failed to assign all query results to OrderDetail slice")
	}
...
// CountG returns the count of all OrderDetail records in the query using the global executor
func (q orderDetailQuery) CountG(ctx context.Context) (int64, error) {
...
func (q orderDetailQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to count order_details rows")
	}
...
func (q orderDetailQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q orderDetailQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "source: failed to check if order_details exists")
	}
...
func OrderDetails(mods ...qm.QueryMod) orderDetailQuery {
	mods = append(mods, qm.From("\"source\".\"order_details\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"source\".\"order_details\".*"})
	}

	return orderDetailQuery{q}
}

// FindOrderDetailG retrieves a single record by ID.
func FindOrderDetailG(ctx context.Context, orderNo int, orderDetailNo int, selectCols ...string) (*OrderDetail, error) {
	return FindOrderDetail(ctx, boil.GetContextDB(), orderNo, orderDetailNo, selectCols...)
}
...
func FindOrderDetail(ctx context.Context, exec boil.ContextExecutor, orderNo int, orderDetailNo int, selectCols ...string) (*OrderDetail, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"source\".\"order_details\" where \"order_no\"=$1 AND \"order_detail_no\"=$2", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "source: unable to select from order_details")
	}
...
func (o *OrderDetail) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *OrderDetail) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("source: no order_details provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"source\".\"order_details\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"source\".\"order_details\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "source: unable to insert into order_details")
	}
...
// UpdateG a single OrderDetail record using the global executor.
// See Update for more documentation.
func (o *OrderDetail) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (o *OrderDetail) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("source: unable to update order_details, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"source\".\"order_details\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to update order_details row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to get rows affected by update for order_details")
	}
...
func (q orderDetailQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (q orderDetailQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to update all for order_details")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to retrieve rows affected for order_details")
	}
...
// UpdateAllG updates all rows with the specified column values.
func (o OrderDetailSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o OrderDetailSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"source\".\"order_details\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to update all in orderDetail slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to retrieve rows affected all in update all orderDetail")
	}
	return rowsAff, nil
}

// UpsertG attempts an insert, and does an update or ignore on conflict.
func (o *OrderDetail) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
...
func (o *OrderDetail) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("source: no order_details provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("source: unable to upsert order_details, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(orderDetailPrimaryKeyColumns) == 0 {
				return errors.New("source: unable to upsert order_details, could not build conflict column list")
			}

			conflict = make([]string, len(orderDetailPrimaryKeyColumns))
			copy(conflict, orderDetailPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"source\".\"order_details\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "source: unable to upsert order_details")
	}
...
// DeleteG deletes a single OrderDetail record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *OrderDetail) DeleteG(ctx context.Context) (int64, error) {
...
func (o *OrderDetail) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("source: no OrderDetail provided for delete")
	}
	...
	sql := "DELETE FROM \"source\".\"order_details\" WHERE \"order_no\"=$1 AND \"order_detail_no\"=$2"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to delete from order_details")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to get rows affected by delete for order_details")
	}
...
func (q orderDetailQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (q orderDetailQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("source: no orderDetailQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to delete all from order_details")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to get rows affected by deleteall for order_details")
	}
...
func (o OrderDetailSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o OrderDetailSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"source\".\"order_details\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to delete all from orderDetail slice")
	}
...
func (o *OrderDetail) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("source: no OrderDetail provided for reload")
	}
...
func (o *OrderDetailSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("source: empty OrderDetailSlice provided for reload all")
	}
...
func (o *OrderDetailSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"source\".\"order_details\".* FROM \"source\".\"order_details\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, orderDetailPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "source: unable to reload all in OrderDetailSlice")
	}
...
// OrderDetailExistsG checks if the OrderDetail row exists.
func OrderDetailExistsG(ctx context.Context, orderNo int, orderDetailNo int) (bool, error) {
	return OrderDetailExists(ctx, boil.GetContextDB(), orderNo, orderDetailNo)
}
...
func OrderDetailExists(ctx context.Context, exec boil.ContextExecutor, orderNo int, orderDetailNo int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"source\".\"order_details\" where \"order_no\"=$1 AND \"order_detail_no\"=$2 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "source: unable to check if order_details exists")
	}

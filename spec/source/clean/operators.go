...
var OperatorWhere = struct {
	...
	OperatorID:   whereHelperstring{field: "\"clean\".\"operators\".\"operator_id\""},
	OperatorName: whereHelperstring{field: "\"clean\".\"operators\".\"operator_name\""},
	CreatedAt:    whereHelpertime_Time{field: "\"clean\".\"operators\".\"created_at\""},
	UpdatedAt:    whereHelpertime_Time{field: "\"clean\".\"operators\".\"updated_at\""},
	CreatedBy:    whereHelpernull_String{field: "\"clean\".\"operators\".\"created_by\""},
	UpdatedBy:    whereHelpernull_String{field: "\"clean\".\"operators\".\"updated_by\""},
}
...
func (q operatorQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Operator, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "clean: failed to execute a one query for operators")
	}
...
func (q operatorQuery) All(ctx context.Context, exec boil.ContextExecutor) (OperatorSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "clean: failed to assign all query results to Operator slice")
	}
...
func (q operatorQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "clean: failed to count operators rows")
	}
...
func (q operatorQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "clean: failed to check if operators exists")
	}
...
func Operators(mods ...qm.QueryMod) operatorQuery {
	mods = append(mods, qm.From("\"clean\".\"operators\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"clean\".\"operators\".*"})
	}
...
func FindOperator(ctx context.Context, exec boil.ContextExecutor, operatorID string, selectCols ...string) (*Operator, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"clean\".\"operators\" where \"operator_id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "clean: unable to select from operators")
	}
...
func (o *Operator) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("clean: no operators provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"clean\".\"operators\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"clean\".\"operators\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "clean: unable to insert into operators")
	}
...
func (o *Operator) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("clean: unable to update operators, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"clean\".\"operators\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to update operators row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "clean: failed to get rows affected by update for operators")
	}
...
func (q operatorQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to update all for operators")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to retrieve rows affected for operators")
	}
...
func (o OperatorSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"clean\".\"operators\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to update all in operator slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to retrieve rows affected all in update all operator")
	}
	return rowsAff, nil
}
...
func (o *Operator) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("clean: no operators provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("clean: unable to upsert operators, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(operatorPrimaryKeyColumns) == 0 {
				return errors.New("clean: unable to upsert operators, could not build conflict column list")
			}

			conflict = make([]string, len(operatorPrimaryKeyColumns))
			copy(conflict, operatorPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"clean\".\"operators\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "clean: unable to upsert operators")
	}
...
func (o *Operator) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("clean: no Operator provided for delete")
	}
	...
	sql := "DELETE FROM \"clean\".\"operators\" WHERE \"operator_id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to delete from operators")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "clean: failed to get rows affected by delete for operators")
	}
...
func (q operatorQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("clean: no operatorQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to delete all from operators")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "clean: failed to get rows affected by deleteall for operators")
	}
...
func (o OperatorSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"clean\".\"operators\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "clean: unable to delete all from operator slice")
	}
...
func (o *OperatorSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"clean\".\"operators\".* FROM \"clean\".\"operators\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, operatorPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "clean: unable to reload all in OperatorSlice")
	}
...
func OperatorExists(ctx context.Context, exec boil.ContextExecutor, operatorID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"clean\".\"operators\" where \"operator_id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "clean: unable to check if operators exists")
	}

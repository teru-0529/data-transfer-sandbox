...
var ProductWhere = struct {
	...
	ProductName: whereHelperstring{field: "\"source\".\"products\".\"product_name\""},
	CostPrice:   whereHelperint{field: "\"source\".\"products\".\"cost_price\""},
	CreatedAt:   whereHelpertime_Time{field: "\"source\".\"products\".\"created_at\""},
	UpdatedAt:   whereHelpertime_Time{field: "\"source\".\"products\".\"updated_at\""},
	CreatedBy:   whereHelpernull_String{field: "\"source\".\"products\".\"created_by\""},
	UpdatedBy:   whereHelpernull_String{field: "\"source\".\"products\".\"updated_by\""},
}
...
func (q productQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Product, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "source: failed to execute a one query for products")
	}
...
func (q productQuery) All(ctx context.Context, exec boil.ContextExecutor) (ProductSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "source: failed to assign all query results to Product slice")
	}
...
func (q productQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to count products rows")
	}
...
func (q productQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "source: failed to check if products exists")
	}
...
func Products(mods ...qm.QueryMod) productQuery {
	mods = append(mods, qm.From("\"source\".\"products\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"source\".\"products\".*"})
	}
...
func FindProductG(ctx context.Context, productName string, selectCols ...string) (*Product, error) {
	return FindProduct(ctx, boil.GetContextDB(), productName, selectCols...)
}
...
func FindProduct(ctx context.Context, exec boil.ContextExecutor, productName string, selectCols ...string) (*Product, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"source\".\"products\" where \"product_name\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "source: unable to select from products")
	}
...
func (o *Product) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("source: no products provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"source\".\"products\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"source\".\"products\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "source: unable to insert into products")
	}
...
func (o *Product) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("source: unable to update products, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"source\".\"products\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to update products row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to get rows affected by update for products")
	}
...
func (q productQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to update all for products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to retrieve rows affected for products")
	}
...
func (o ProductSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"source\".\"products\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to update all in product slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to retrieve rows affected all in update all product")
	}
	return rowsAff, nil
}
...
func (o *Product) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("source: no products provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("source: unable to upsert products, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(productPrimaryKeyColumns) == 0 {
				return errors.New("source: unable to upsert products, could not build conflict column list")
			}

			conflict = make([]string, len(productPrimaryKeyColumns))
			copy(conflict, productPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"source\".\"products\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "source: unable to upsert products")
	}
...
func (o *Product) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("source: no Product provided for delete")
	}
	...
	sql := "DELETE FROM \"source\".\"products\" WHERE \"product_name\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to delete from products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to get rows affected by delete for products")
	}
...
func (q productQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("source: no productQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to delete all from products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "source: failed to get rows affected by deleteall for products")
	}
...
func (o ProductSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"source\".\"products\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "source: unable to delete all from product slice")
	}
...
func (o *Product) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("source: no Product provided for reload")
	}
...
func (o *ProductSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("source: empty ProductSlice provided for reload all")
	}
...
func (o *ProductSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"source\".\"products\".* FROM \"source\".\"products\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, productPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "source: unable to reload all in ProductSlice")
	}
...
func ProductExistsG(ctx context.Context, productName string) (bool, error) {
	return ProductExists(ctx, boil.GetContextDB(), productName)
}
...
func ProductExists(ctx context.Context, exec boil.ContextExecutor, productName string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"source\".\"products\" where \"product_name\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "source: unable to check if products exists")
	}
